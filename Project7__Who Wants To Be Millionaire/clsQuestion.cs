...
namespace Project7__Who_Wants_To_Be_Millionaire
{
    ...
    internal class clsQuestion
    {
        ...
        private static string EasyQuestionFilePath = @"easy_questions.txt";  //Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "QuestionsFiles", "easy_questions.txt");
        private static string MediumQuestionFilePath = @"medium_questions.txt";//Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "QuestionsFiles", "medium_questions.txt") ;
        private static string HardQuestionFilePath = @"hard_questions.txt";  //Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "QuestionsFiles", "hard_questions.txt");
